                ...
                <tbody>
                    <?php $__currentLoopData = $funcionarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-200">
                            <td class="py-4 px-6 border-b text-gray-800 text-lg"><?php echo e($f->name); ?></td>
                            <td class="py-4 px-6 border-b text-gray-600"><?php echo e($f->phone); ?></td>
                            <td class="py-4 px-6 border-b text-gray-600"><?php echo e($f->function); ?></td>
                            <td class="py-4 px-6 border-b text-gray-600"><?php echo e($f->salary); ?></td>
                            <td class="py-4 px- border-b whitespace-nowrap">
                                <a class="text-blue-600 hover:text-blue-800 mr-4" href="<?php echo e(route('funcionarios.edit', ['funcionario' => $f->id])); ?>">Editar</a> 
                                <form class="inline" action="<?php echo e(route('funcionarios.destroy', ['funcionario' => $f->id])); ?>" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este funcionário?');">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/funcionarios/index.blade.php ENDPATH**/ ?>