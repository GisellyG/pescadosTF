...
<?php if($viveiros->isNotEmpty()): ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $viveiros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-200">
                            <td class="py-4 px-6 border-b text-gray-800 text-lg"><?php echo e($v->name); ?></td>
                            <td class="py-4 px-6 border-b text-gray-600"><?php echo e($v->area/10000); ?>ha</td>
                            ...
                            <td class="py-4 px-6 border-b text-gray-600"><?php echo e($v->date ?? 'Sem biometria'); ?></td>
                            <td class="py-4 px- border-b whitespace-nowrap">
                                <a class="text-blue-600 hover:text-blue-800 mr-4" href="<?php echo e(route('viveiros.edit', ['viveiro' => $v->id])); ?>">Editar</a> 
                                <form class="inline" action="<?php echo e(route('viveiros.destroy', ['viveiro' => $v->id])); ?>" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este viveiro?');">
                                    <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="flex items-center justify-center h-64">
            <p class="text-gray-500 text-3xl text-center">Nenhum viveiro cadastrado.</p>
        </div>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/viveiros/index.blade.php ENDPATH**/ ?>