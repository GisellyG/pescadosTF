            ...
            <form method="POST" action="<?php echo e(route('funcionarios.store')); ?>">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="tel" name="telefone" value="<?php echo e(old('telefone')); ?>" required >
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="validity">Função*</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="text" name="funcao" value="<?php echo e(old('funcao')); ?>" required>
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="validity">Salário*</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="" name="salario" value="<?php echo e(old('salario')); ?>" required>
                    </div>
                </div>

                <div class="flex justify-end mt-6">
                    <a href="<?php echo e(route('funcionarios.index')); ?>" class="py-2 px-4 leading-tight border border-gray-200 text-blue-700 rounded-l mr-4">Voltar</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/funcionarios/create.blade.php ENDPATH**/ ?>