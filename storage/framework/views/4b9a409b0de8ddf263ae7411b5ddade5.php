            ...
            <form method="POST" action="<?php echo e(route('products.store')); ?>">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="text" name="nome" value="<?php echo e(old('nome')); ?>" required>
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="quantity">Quantidade*</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="quantidade" value="<?php echo e(old('quantidade')); ?>" required >
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="validity">Lote*</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" name="lote" value="<?php echo e(old('lote')); ?>" required>
                    </div>
                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="validity">Data de Validade*</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" name="validade" value="<?php echo e(old('validade')); ?>" required>
                    </div>
                </div>

                <div class="flex justify-end mt-6">
                    <a href="<?php echo e(route("products.index")); ?>" class="py-2 px-4 leading-tight border border-gray-200 text-blue-700 rounded-l mr-4">Voltar</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/product/create.blade.php ENDPATH**/ ?>