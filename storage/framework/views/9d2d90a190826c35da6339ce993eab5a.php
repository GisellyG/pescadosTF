...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mt-4 flex justify-center">
        <div class=" shadow-lg w-full sm:w-1/2 rounded-lg mt-8">
            ...
            <div class="p-6">
            <form method="POST" action="<?php echo e(route('viveiros.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="largura" value="<?php echo e(old('largura')); ?>" required>
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="length">Comprimento* (m)</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="comprimento" value="<?php echo e(old('comprimento')); ?>" required>
                    </div>
                </div> 

                <div class="flex justify-end mt-6">
                    <a href="<?php echo e(route("viveiros.index")); ?>" class="py-2 px-4 leading-tight border border-gray-200 text-blue-700 rounded-l mr-4">Voltar</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/viveiros/create.blade.php ENDPATH**/ ?>