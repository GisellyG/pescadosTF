        ...
        <div class="alert-box inline-flex max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden absolute top-1 left-1/2 transform -translate-x-1/2 z-50">
            ...
            <div class="-mx-3 py-2 px-4 flex-1">
                <div class="mx-3">
                    ...
                    <p class="text-gray-600 text-sm"><?php echo e($error); ?></p>
                </div>
            </div>
...
<?php endif; ?>
        ...
        <div class="mt-4 flex justify-center">
            <div class=" shadow-lg w-full sm:w-1/2 rounded-lg mt-8">
                ...
                <div class="p-6">
                <form method="POST" action="<?php echo e(route('biometrias.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="flex flex-col">
                            <label class="text-gray-700 mb-1" for="weight">Peso* (g)</label>
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="peso" id="weight" step="0.01" value="<?php echo e(old('peso')); ?>"  required>
                        </div>
    
                        <div class="flex flex-col">
                            <label class="text-gray-700 mb-1" for="quantity">Quantidade de Camarões*</label>
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="quantidade" name="quantidade" value="<?php echo e(old('quantidade')); ?>" required >
                        </div>
                        <div class="flex flex-col">
                            ...
                            <select name="viveiro_id" id="viveiro_id" class="form-input w-full mt-2 rounded-md focus:border-indigo-600">
                                ...
                                <?php $__currentLoopData = $viveiros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $viveiro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($viveiro->id); ?>" <?php echo e(old('viveiro_id') == $viveiro->id ? 'selected' : ''); ?>>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" name="data" id="date" value="<?php echo e(old('data')); ?>" required>
                        </div>
                        ...
                        <div class=" col-span-2 flex flex-col">
                            ...
                            <textarea class="form-input w-full mt-2 rounded-md focus:border-indigo-600" name="observacao" <?php echo e(old('observacao')); ?> required> <?php echo e(old('observacao')); ?></textarea>
                        </div>
                    </div>
    
                    <div class="flex justify-end mt-6">
                        <a href="<?php echo e(route("biometrias.index")); ?>" class="py-2 px-4 leading-tight border border-gray-200 text-blue-700 rounded-l mr-4">Voltar</a>
...
<?php endif; ?><?php /**PATH C:\Users\gisel\Documents\Laravel\pescadosTF\resources\views/biometrias/create.blade.php ENDPATH**/ ?>